...
<table style="margin: 5px auto; width: calc(100% - 20px);">
    <tr>
        ...
        <th class="right">문의 제목</th>
        <th class="right">문의 날짜</th>
        <th class="right">답변 유무</th>
        <th class="right">답변 날짜</th>
        <th>글 삭제</th>
    </tr>
    <c:forEach items="${inquiryList}" var="bag"> <!-- <>안에 begin="0" end="16" 적어주면 범위 지정 가능 -->
        <tr>
            <td class="top right">${bag.myinquiry_no}</td>
            <td class="top right"><a href="one_inquiry?inquiry_no=${bag.inquiry_no}">${bag.inquiry_title}</a></td>
